...
class MultiAgentArena(MultiAgentEnv):
    def __init__(self, config=None):
        ...
        # MultiDiscrete([self.width * self.height,
    ...
    def reset(self):
        ...
        self.coverage_map[self.agent1_pos[0], self.agent1_pos[1]] = 1;
        self.coverage_map[self.agent2_pos[0], self.agent2_pos[1]] = 1;
...
new_trainer.restore("checkpoint_000400")
